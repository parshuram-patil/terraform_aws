...
resource "aws_api_gateway_method" "first_nested_get" {
  rest_api_id   = aws_api_gateway_rest_api.example.id
  resource_id   = aws_api_gateway_resource.first_nested.id
  http_method   = "GET"
  authorization = "NONE"
}

resource "aws_api_gateway_integration" "first_nested" {
  rest_api_id = aws_api_gateway_rest_api.example.id
  resource_id = aws_api_gateway_method.first_nested_get.resource_id
  http_method = aws_api_gateway_method.first_nested_get.http_method
...
resource "aws_api_gateway_deployment" "first_nested_deployment" {
  depends_on = [
    aws_api_gateway_integration.first_nested
  ]
